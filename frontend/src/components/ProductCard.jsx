...
const ProductCard = ({ product }) => {
  ...
  const productImage = product.images && product.images.length > 0 ? getImagePath(product.images[0]) : (product.image ? getImagePath(product.image) : null);
  ...
  return (
    ...
    >
      ...
      <div className="relative bg-gray-100 h-64 flex items-center justify-center overflow-hidden">
        ...
        <div className={`absolute inset-0 flex items-center justify-center bg-gradient-to-br from-gray-200 to-gray-300 ${productImage ? 'hidden' : ''}`} aria-hidden="true">
